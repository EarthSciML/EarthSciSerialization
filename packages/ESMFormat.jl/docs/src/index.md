```@meta
CurrentModule = ESMFormat
```

# ESMFormat.jl

Documentation for [ESMFormat.jl](https://github.com/EarthSciML/EarthSciSerialization).

ESMFormat.jl is a Julia library for working with the EarthSciML Serialization Format (ESM format),
