...
const ModelEditorDemo = () => {
    ...
    const handleModelChange = (updatedModel) => {
    ...
    return (<div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <ModelEditor model={model()} onChange={handleModelChange} allowEditing={true} showValidation={true} validationErrors={validationErrors()}/>
        </div>
      ...
      <div style={{
        ...
        <label style={{ "display": "flex", "align-items": "center", "gap": "8px" }}>
          <input type="checkbox" checked={showJSON()} onChange={(e) => setShowJSON(e.currentTarget.checked)}/>
          Show JSON representation
        </label>

        <div style={{ "margin-top": "12px" }}>
          <button onClick={() => setModel(initialModel)} style={{
            "padding": "8px 16px",
            "background": "#007bff",
            "color": "white",
            "border": "none",
          ...
          <button onClick={() => console.log('Current model:', model())} style={{
            "padding": "8px 16px",
            "background": "#28a745",
            "color": "white",
            "border": "none",
...
//# sourceMappingURL=ModelEditor.demo.jsx.map