...
# Try to load EarthSciSerialization despite warnings
try
    using EarthSciSerialization
    println("EarthSciSerialization loaded successfully (with warnings)")
catch e
    println("Failed to load EarthSciSerialization: $e")
    exit(1)
end
