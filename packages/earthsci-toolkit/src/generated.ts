...
export interface Model {
  /**
   * Optional per-component semver string identifying this component's content revision. Distinct from the top-level 'esm' field, which versions the spec/format. Authors set this when shipping a component intended for reuse so other files can pin to a specific revision.
   */
  version?: string;
  /**
...
export interface ReactionSystem {
  /**
   * Optional per-component semver string identifying this component's content revision. Distinct from the top-level 'esm' field, which versions the spec/format.
   */
  version?: string;
  /**
...
export interface DataLoader {
  /**
   * Optional per-component semver string identifying this data loader's content revision.
   */
  version?: string;
  /**
...
export interface Operator {
  /**
   * Optional per-component semver string identifying this operator's content revision.
   */
  version?: string;
  /**
...
export interface Domain {
  /**
   * Optional per-component semver string identifying this domain's content revision.
   */
  version?: string;
  /**
...
export interface Interface {
  /**
   * Optional per-component semver string identifying this interface's content revision.
   */
  version?: string;
  description?: string;
  /**
