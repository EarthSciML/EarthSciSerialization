    ...
    describe('simplify', () => {
        ...
        describe('exponentiation simplification', () => {
            ...
            it('should simplify 1^x to 1', () => {
                const expr = { op: '^', args: [1, 'x'] };
                expect(simplify(expr)).toBe(1);
            });
            it('should fold constants', () => {
                const expr = { op: '^', args: [2, 3] };
