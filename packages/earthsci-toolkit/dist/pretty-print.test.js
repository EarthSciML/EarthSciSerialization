...
// Load test fixtures
const chemicalSubscriptsFixtures = JSON.parse(readFileSync(join(process.cwd(), '../../tests/display/chemical_subscripts.json'), 'utf8'));
const comprehensiveOperatorsFixtures = JSON.parse(readFileSync(join(process.cwd(), '../../tests/display/comprehensive_operators.json'), 'utf8'));
describe('Chemical Subscripts', () => {
    chemicalSubscriptsFixtures.forEach((fixture, index) => {
...
describe('Expression Operators', () => {
    comprehensiveOperatorsFixtures.forEach((group) => {
        describe(group.name, () => {
