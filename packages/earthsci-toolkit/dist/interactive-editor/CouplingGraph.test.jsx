...
describe('CouplingGraph', () => {
    ...
    let mockOnEditCoupling;
    let mockOnSelectComponent;
    beforeEach(() => {
    ...
    it('renders the coupling graph SVG', () => {
        render(() => (<CouplingGraph esmFile={mockEsmFile} width={800} height={600}/>));
    ...
    it('calls onSelectComponent when node is clicked', async () => {
        render(() => (<CouplingGraph esmFile={mockEsmFile} onSelectComponent={mockOnSelectComponent} interactive={true} width={800} height={600}/>));
    ...
    it('calls onEditCoupling when edge is clicked', async () => {
        render(() => (<CouplingGraph esmFile={mockEsmFile} onEditCoupling={mockOnEditCoupling} interactive={true} width={800} height={600}/>));
    ...
    it('shows component details panel when node is selected', async () => {
        render(() => (<CouplingGraph esmFile={mockEsmFile} interactive={true} width={800} height={600}/>));
    ...
    it('handles empty ESM file gracefully', () => {
        ...
        render(() => (<CouplingGraph esmFile={emptyEsmFile} width={800} height={600}/>));
    ...
    it('uses default dimensions when width/height not provided', () => {
        render(() => (<CouplingGraph esmFile={mockEsmFile}/>));
        const svg = screen.getByRole('img', { hidden: true });
    ...
    it('disables interaction when interactive=false', () => {
        render(() => (<CouplingGraph esmFile={mockEsmFile} onSelectComponent={mockOnSelectComponent} interactive={false} width={800} height={600}/>));
...
//# sourceMappingURL=CouplingGraph.test.jsx.map