...
describe('Schema Edge Cases', () => {
    ...
    describe('empty and null field handling', () => {
        ...
        it('should fail when required fields are null', () => {
            ...
            const typeError = errors.find(error => error.path.includes('name') && error.keyword === 'type');
    ...
    describe('additional properties validation', () => {
        ...
        it('should fail with additional properties in metadata', () => {
            ...
            expect(errors.length).toBeGreaterThan(0);
            const additionalPropsError = errors.find(error => error.keyword === 'additionalProperties' && error.path.includes('metadata'));
            expect(additionalPropsError).toBeDefined();
    ...
    describe('schema evolution compatibility', () => {
        it('should enforce exact version match', () => {
            ...
            const versionError = errors.find(error => error.keyword === 'const' && error.path.includes('esm'));
        ...
        it('should fail with invalid version format', () => {
            ...
            const patternError = errors.find(error => error.keyword === 'pattern' || error.keyword === 'const');
        ...
        it('should fail with invalid datetime formats', () => {
            ...
            const formatError = errors.find(error => error.keyword === 'format');
        ...
        it('should fail with invalid URI formats', () => {
            ...
            expect(errors.length).toBeGreaterThan(0);
            // Should find format validation error
            const formatError = errors.find(error => error.keyword === 'format' && error.message?.includes('uri'));
            expect(formatError).toBeDefined();
    ...
    describe('conditional schema: observed variables require expression field', () => {
        it('should fail when observed variable lacks expression', () => {
            ...
            const expressionError = errors.find(error => error.path.includes('bad_observed') ||
...
//# sourceMappingURL=schema-edge-cases.test.js.map