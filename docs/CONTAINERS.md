...
# Run Python tests
docker pull ghcr.io/ctessum/earthsci-toolkit-python:latest
docker run --rm -v $(pwd)/results:/workspace/conformance-results ghcr.io/ctessum/earthsci-toolkit-python:latest
```
...
| Python     | `earthsci-toolkit-python` | `python:3.11-bookworm` | ~300MB | amd64, arm64 |
| Rust       | `earthsci-toolkit` | `rust:1.70-bookworm` | ~200MB | amd64, arm64 |
